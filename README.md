...
3. **Install dependencies**:
   ```bash
   pip install PyQt6 pandas openpyxl scikit-learn joblib radon astunparse
   ```
...
**Note**: This system is designed for educational environments and should be used responsibly in accordance with institutional policies on academic integrity.# Cheating Detection System
